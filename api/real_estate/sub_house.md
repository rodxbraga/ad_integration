...
| `home_features` | `1` para Ar condicionado<br> `4` para Varanda<br> `5` para Área de serviço<br> `6` para Churrasqueira<br> `7` para Quarto de serviço<br> `8` para Piscina<br> `9` para Armários na cozinha<br> `10` para Mobiliado | array de strings | Não | Detalhes do imóvel |
