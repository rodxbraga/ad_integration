...
| `motorpower` | `1` para 1<br> `2` para 1.2<br> `3` para 1.3<br> `4` para 1.4<br> `5` para 1.5<br> `6` para 1.6<br> `7` para 1.7<br> `8` para 1.8<br> `9` para 1.9<br> `10` para 2.0 - 2.9<br> `11` para 3.0 - 3.9<br> `12` para 4.0 ou mais | string | Não | Potência do motor |
| `cartype` | `1` para Passeio<br> `2` para Conversível<br> `3` para Pick-up<br> `4` para Antigo<br> `5` para SUV<br> `6` para Buggy<br> `7` para Van/Utilitário<br> `8` para Sedã<br> `9` para Hatch | string | Não | Tipo de automóvel |
| `carcolor` | `1` para Preto<br>`2` para Branco<br>`3` para Prata<br>`4` para Vermelho<br>`5` para Cinza<br>`6` para Azul<br>`7` para Amarelo<br>`8` para Verde<br>`9` para Laranja<br>`10` para Outra | string | Não | Cor do automóvel |
