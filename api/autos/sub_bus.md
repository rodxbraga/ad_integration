...
| `bustype` | `1` para Ônibus<br> `2` para Micro ônibus<br> `3` para Outros | string | Não<sup>1</sup> | Tipo de ônibus |
| `bus_features` | `1` para Ar condicionado | array de strings | Não<sup>1</sup> | Opcionais |
